...
public class SetFnsTest {
  ...
  public void testCommons() {
    ...
    PCollection<String> left =
        p.apply(Create.of("a", "b", "c", "d").withCoder(StringUtf8Coder.of()));

    PCollection<String> right =
        p.apply(Create.of("a", "b", "e", "f").withCoder(StringUtf8Coder.of()));
  ...
  public void testDifference() {
    ...
    PAssert.that(results).containsInAnyOrder("e", "f");
